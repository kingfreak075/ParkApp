...
turniList = (turniList || []).map(t => {
    const copia = { ...t };
    copia.parziali = parzialiMap[t.id] || [];
    return copia;
});
...
// --- Aggiungi questa funzione vicino alle altre funzioni di caricamento dati (es. dopo caricaTurni() o caricaTecnici()) ---
